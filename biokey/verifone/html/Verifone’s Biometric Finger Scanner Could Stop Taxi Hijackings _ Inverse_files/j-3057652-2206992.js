...
(function(){
    ...
    (function() {
    var p = "3057652", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3057652||'',
    guid:window.ftGUID_3057652||'',
    confID:window.ftConfID_3057652||'0',
    ftReturn: window.ftReturn_3057652||'',
    keyword:window.ftKeyword_3057652||'',
    ftId:window.ftId_3057652||'',
    ftImpId:window.ftImp3057652 && window.ftImp3057652.impID || '',
    campaignID: '90280',
    cID:'88047',
    pID:'3057652',
    creativeID:'2206992',
    exttrack:[],
    extscript:[""],
    clickTags: ['http://servedby.flashtalking.com/click/1/90280;3057652;2206992;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=http://www.coingeekhkconference.com/?utm_source=mediaiq&utm_medium=display&utm_campaign=conference&utm_term=speaker_a&utm_content=pros'],
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?110085198-3057652;2206992;',
    centreAd: false,
    width:300,
    height:250,
    adType:'HTML_standard'.toLowerCase(),
    altimg:'http://cdn.flashtalking.com/xre/305/3057652/2206992/image/2206992.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/1/90280;3057652;202;pixel;MediaIQ;300x250Pros/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref:'http://servedby.flashtalking.com/click/1/90280;3057652;2206992;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=http://www.coingeekhkconference.com/?utm_source=mediaiq&utm_medium=display&utm_campaign=conference&utm_term=speaker_a&utm_content=pros',
    divID:'ftdiv3057652',
    altimgID:'ftalt3057652',
    alttext:'Click here',
    iDeviceImp:'http://servedby.flashtalking.com/imp/1/90280;3057652;207;guid;MediaIQ;300x250Pros/?ft_guid=',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp3057652 && parseInt(window.ftImp3057652.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m3057652') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3057652'),
    pageVisible: 'maybe',
...
(function(o) {
    ...
    o.frameID = 'ftframe3057652';
    o.file = 'http://cdn.flashtalking.com/88047/2206992/index.html';
    o.altImg = 'http://servedby.flashtalking.com/imp/1/90280;3057652;204;gif;MediaIQ;300x250Pros/?';
    ...
    o.applyClickTag = function() {
        ...
        ct.style.cssText = 'cursor: pointer; position:absolute; width:' + this.width + 'px; height:' + this.height + 'px; z-index: 89000; background: url("about:blank");top:0;left:0;';
    ...
    function dummyInit() {
        ...
        frame.onload = function init(e) {
            var msg = {
                ...
                newImp: "//servedby.flashtalking.com/imp/1/" + o.campaignID + ";" + o.pID + ";207;guid;" + o.siteName + ";" + o.placementDescription + "/?ft_guid=" + o.GUID + "&cachebuster=" + o.random()
            };
